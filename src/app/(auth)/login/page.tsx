    ...
    return (
      <div className="space-y-6 opacity-0 animate-fade-up">
        <div className="space-y-2">
          <h2 className="text-3xl font-bold tracking-tight text-foreground">Already signed in</h2>
          <p className="text-sm text-muted-foreground">
            You are logged in as {user.full_name}. To use another account, please logout first.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          <Button asChild className="flex-1">
            <Link href={roleDashboardPath(user.role)}>Go to dashboard</Link>
          </Button>
          <Button type="button" variant="outline" className="flex-1" loading={loading} onClick={handleLogoutFirst}>
            Logout first
          </Button>
        </div>
      </div>
